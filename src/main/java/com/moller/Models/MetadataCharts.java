...
public class MetadataCharts {
    ...
    public static MetadataObject[] GetExifDirectory() {
         ...
         * new MetadataObject(0x0124, "T4Options", "Long", 0), new
         * MetadataObject(0x0125, "T6Options", "Long", 0),
         * // TODO: How do I add this? List for dropdown?
         ...
         * new MetadataObject(0x0132, "DateTime", "String", 0), new
         * MetadataObject(0x013b, "Artist", "String", 0),
